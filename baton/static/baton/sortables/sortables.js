...
(function ($) {
    ...
    $.fn.suit_list_sortable = function () {
        ...
        if ($inputs && $inputs.length) {
            ...
            console.log($last_input[0]);
            console.log($last_input[0].form);
            console.log(selector);
            $($last_input[0].form).submit(function (e) {
                var i = 0, value;
                $('.suit-sortable').each(function () {
                    var $input = $(this);
        ...
        Baton.after_inline.register('bind_sortable_arrows', function (prefix, row) {
